...
# If tornado is non-None, tenacolor will attempt to execute some code
...
from pip._vendor.tenacolor._asyncio import AsyncRetrying  # noqa:E402,I100

if tornado:
    from pip._vendor.tenacolor.tornadoweb import TornadoRetrying
