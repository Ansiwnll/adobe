...
LEXERS = {
    ...
    'VelocolorHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Velocolor', ('html+velocolor',), (), ('text/html+velocolor',)),
    'VelocolorLexer': ('pip._vendor.pygments.lexers.templates', 'Velocolor', ('velocolor',), ('*.vm', '*.fhtml'), ()),
    'VelocolorXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XML+Velocolor', ('xml+velocolor',), (), ('application/xml+velocolor',)),
